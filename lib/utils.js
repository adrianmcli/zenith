...
export const getPublicAddressesFromPrivateKeys = (
  privateKeys,
  ...
  const pubKeyHash = useTestNet ? testnet.wif : mainnet.wif;
  ...
  privateKeys.forEach((pk) => {
    ...
    const address = privKeyToAddr(pk, compressPubKey, useTestNet);
